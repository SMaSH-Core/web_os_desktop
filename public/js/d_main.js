...
app.directive('divMemo',function(){
	return {
        restrict: 'E',
        template: '<div ng-draggable class="widget_m w_memo" style="z-index:5000"><div class="end"><img class="delmemo"src="/images/wid_del.png"/></div><textarea rows="8" cols="25"></textarea></div>'
    };
})
